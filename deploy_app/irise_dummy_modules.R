...
#' Search Page Module
#'
#' This shiny module generates the search page for the app
#'
#' @param id The module identifier.
#' @param pico_element_list A list of dynamic search updates based on the pico dropdown filters.
#' @param pico_table_list A list of the dataframes required. These must link to the element list. (i.e. pico_element_1 uses the same data as pico_table_1)
      ...
      filter_results <- reactive({
        ...
        if(values$reset_button == "reset"){
          ...
          selected_studies <- selected_studies %>%
            ...
            distinct() %>% 
            select(year, author, title, author_aff_country, population, intervention, discipline, uid)
...
#'
#' This shiny module creates a number of reactive dropdown menus using the columns selected.
#' @param id The module identifier.
#' @param column The name of the column to use for generating the dropdown.
#' @param column2 The name of the column to use for generating the second dropdown. 
#' @param column3 The name of the column to use for generating the third dropdown. 
#' @param column4 The name of the column to use for generating the fourth dropdown. 
#' @param label1 The label shown above the first input.
#' @param label2 The label shown above the second input.
#' @param label3 The label shown above the third input.
#' @param label4 The label shown above the fourth input.
...
#'
#' This is the server function for the pico dropdown module. It takes a dataframe, a number of columns and the number of dropdowns required (filter_no). 
#'
#' @param id The module identifier.
#' @param table The data table to use for generating the chart.
#' @param column1 The name of the column to use for generating the dropdown.
