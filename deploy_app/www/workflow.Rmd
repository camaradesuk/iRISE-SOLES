...
Guided by a pre-registered [protocol](https://osf.io/2vufx/?view_only=d74ff8089864468cb43daa06733e0be6){target="_blank" rel="noopener"}, we performed a wide-ranging search in January 2024 spanning multiple databases to identify research of interest. Our full search strategy is available [here](https://osf.io/kawfz/?view_only=d74ff8089864468cb43daa06733e0be6){target="_blank" rel="noopener"}.

In total, we identified 123,916 articles. We used the Automated Systematic Search Deduplicator [(ASySD)](https://bmcbiol.biomedcentral.com/articles/10.1186/s12915-023-01686-z){target="_blank" rel="noopener"} to identify and remove duplicates automatically. After deduplication, we had 68,995 articles.
