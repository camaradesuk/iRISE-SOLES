...
pico_elements_list <- list(
  pico_element_1 = list(id = "dropdown_author_country",
                        table = author_location_df,
                        label1 = "Filter by country",
                        label2 = "Filter by continent",
                        column1 = "name",
                        column2 = "main_category",
                        filter_no = 2),
  pico_element_2 = list(id = "dropdown_population",
                        table = population_df,
                        label1 = "Filter by specific population",
                        label2 = "Filter by wider population",
                        column1 = "name",
                        column2 = "main_category",
                        filter_no = 2),
  pico_element_3 = list(id = "dropdown_intervention",
                        ...
                        column1 = "name",
                        filter_no = 1),
  pico_element_4 = list(id = "dropdown_discipline",
                        table = discipline_df,
...
ui <- bs4DashPage(freshTheme = mytheme,
                  ...
                  dbHeader <- dashboardHeader(title = "iRISE-SOLES pilot",
